...
require_once(t3lib_extMgm::extPath('addresses', 'Module/Classes/Domain/Model/GroupRepository.php'));
 ...
 * @version 	$Id$
 */
class Tx_Addresses_Controller_GroupController extends Tx_Addresses_Controller_ControllerAbstract{
