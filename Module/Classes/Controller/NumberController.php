...
require_once(t3lib_extMgm::extPath('addresses', 'Module/Classes/Domain/Model/NumberRepository.php'));
 ...
 * @version 	$Id$
 */
class Tx_Addresses_Controller_NumberController extends Tx_Addresses_Controller_ControllerAbstract{
