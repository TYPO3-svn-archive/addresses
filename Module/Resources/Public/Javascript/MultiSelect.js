...
Ext.ux.Multiselect = Ext.extend(Ext.form.Field,  {
	...
	onRender: function(ct, position){
		...
		this.fieldSet = this.fs = new Ext.form.FieldSet({
			renderTo: this.el,
			title: this.legend,
			// changed by Fabien
...
Ext.ux.Multiselect.DragZone = function(ms, config){
	...
	Ext.ux.Multiselect.DragZone.superclass.constructor.call(this, this.ms.fs.body, {
...
Ext.ux.Multiselect.DropZone = function(ms, config){
	...
	Ext.ux.Multiselect.DropZone.superclass.constructor.call(this, this.ms.fs.body, {
		containerScroll: true,
		ddGroup: dd
	});
