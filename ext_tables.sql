...
CREATE TABLE tx_addresses_domain_model_address (
  ...
  nationality tinytext unsigned DEFAULT '0' NOT NULL,
  religion tinytext unsigned DEFAULT '0' NOT NULL,
  marital_status int(11) unsigned DEFAULT '0' NOT NULL,
  org_type tinytext unsigned DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_addresses_domain_model_addressgroup (
	...
	remarks text NOT NULL, -- changed old was description
	PRIMARY KEY (uid),
	KEY parent (pid)
);
